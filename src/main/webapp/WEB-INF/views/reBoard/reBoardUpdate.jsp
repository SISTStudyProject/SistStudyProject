									...
									<div id="container">
										<div id="content" role="main">
											...
											<form name="writeForm" id="writeForm" method="post"  enctype="multipart/form-data">
													<input type="hidden" name="itemSeq2" id="itemSeq2" value="${itemSeq }" />
													<h2 itemprop="name" class="product_title entry-title" style="padding:2px;">
													<input type="text" value="${reBoard.reBoardTitle }" id="title" name="title" placeholder="제목을 입력해주세요." style="color:black; width:300px; font-size:14px; border-radius:10px;"/></h2>
													<br>
													<span>
													...
													<textarea id="content2" name="content2" style="border-radius:10px; height:400px; color:black;" placeholder="내용을 입력해주세요." >${reBoard.reBoardContent }</textarea>
													</span>
																		...
																		<div id="respond" class="comment-respond">
																			<form action="#" method="post" id="commentform" class="comment-form" novalidate>
																				<p  style="text-align:right;">
																					...
																					<input name="submit" type="button" id="submit" class="submit" style="background-color:black; border:0px; width:50px;" value="등록"/>
