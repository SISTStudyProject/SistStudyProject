    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form id="editForm">
          ...
          <button type="button" class="btn btn-primary" style=" background-color:black; border-radius:10px;" id="saveChanges">저장</button>
          </div>
        </form>
      </div>
    </div>
										...
										<div id="content" role="main">
											<div itemscope itemtype="http://schema.org/Product" class="product">
												...
												<div class="summary entry-summary">
													...
													<img src="/resources/upload/qnaFolder/${qnaFile.fileName}"  alt="이미지"/>
													</div>
													</c:if>
													</p>
																		...
																		<div id="respond" class="comment-respond">
																			<form action="#" method="post" id="commentform" class="comment-form" novalidate>
																				<p class="comment-form-comment">
																					...
																					<input name="submit" type="button" id="reply" class="submit" style="border-radius:10px;background-color:black; border:0px;" value="등록"/>
																				</p>
																	...
																	<div id="review_form">
																		<div id="respond" class="comment-respond">
																			<form action="#" method="post" id="commentform" class="comment-form" novalidate>
																				...
																				<table>
																				<tr><th></th>
																				<th>🥦 관리자 &nbsp;&nbsp;&nbsp;&nbsp;&nbsp; ${qnaReply.regDate}</th>
																				</tr>
																				</table>
																				</span>
																				<p style="padding:10px; margin:10px;">${qnaReply.replyContent}</p><br>
																				<div style="text-align:right;">
																				<c:if test="${!empty cookieManagerId}">
																				<input name="submit" type="button" id="Mupdate" class="submit" style=" background-color:black; border:0px; width:50px;" value="수정"/>
																				<input name="submit" type="button" id="Mdelete" class="submit" style=" background-color:black; border:0px; width:50px;" value="삭제"/>
																				</c:if>
																				</div>
																				</p>
																				<p class="form-submit"></p>
