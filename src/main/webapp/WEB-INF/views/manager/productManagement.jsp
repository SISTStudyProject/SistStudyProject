					...
					<div class="panel">
						<div class="input-group">
							...
							<select id="searchType" name="searchType" class="form-control">
						    	...
						    	<option value="4" <c:if test='${searchType eq "4"}'> selected </c:if>>내용</option>
						    </select>
							</div>
									...
									<tbody>
											...
											<c:forEach var="itemDataList" items="${itemDataList}" varStatus="status">
												<tr>
													...
													<td style="cursor:pointer" onclick="location.href='/shop/single?itemSeq=${itemDataList.itemSeq}'">${itemDataList.itemName}</td>
